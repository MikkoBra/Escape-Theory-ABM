...
class AthletesNetwork(FacebookSubNetwork):
    ...
    def plot_degree_distribution(self, net_type="Athletes Network", xmax=2000, plot_now=True, bin_count=20):
